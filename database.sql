...
INSERT INTO `build_guia` VALUES (1,1,1,NULL,1,'Recarga de Energia%','HP%','Bônus de cura%','Energia, HP','220% de recarga de energia'),(2,2,2,NULL,2,'ATK% ou Recarga de Energia%','Bônus Pyro%','CRIT Rate&','Recarga de Energia, CRIT Rate, CRIT DMG, ATK%','220-235% de Recarga de Energia'),(3,3,3,'É a arma assinatura da Furina e balancea buffs com o aumento e diminuição da vida, que acontece na utilização da Habilidade Elemental da Furina.',3,'Recarga de Energia% ou HP%','HP%','CRIT Rate%','Recarga de Energia%, HP%, CRIT Rate, CRIT DMG','200% de Recarga de Energia; 40k de HP'),(8,9,16,NULL,6,'Recarga de Energia%','Bônus Dendro%','Taxa Crítica%','Recarga de Energia, Maestria Elemental, Taxa Crítica.','Recarga de Energia +180%.'),(9,8,8,'Maestria Elemental é muito importante no kit da Lauma, com isso melhorando suas habilidades passivas.',7,'Maestria Elemental','Maestria Elemental','Maestria Elemental ou Crit Rate','Maestria Elemental, Crit Rate, Crit DMG','Maestria Elemental 1000; Recarga de Energia 160 - 200%.'),(10,11,6,'É sua arma assinatura, aumentado seu dano.',10,'HP%','Bônus Hydro%','Taxa Crítica%','Recarga de Energia, HP, Crit Rate','Recarga de Energia +170%'),(11,10,12,'Sua arma assinatuua, aumentando seu dano e recarga de energia.',10,'Recarga de Energia%','Bônus Electro%','Taxa Crítica%','ATK, Crit DMG, Recarga de Energia','Recarga de Energia +200%'),(12,4,2,'Bom para o dano daas habilidades do Kaeya.',1,'ATK%','Bônus Cryo%','Crit DMG%','ATK, Crit Rate, Crit DMG','REcarga de Energia 200%'),(13,5,6,'Paasiva universal e alto valor de DMG bônus',3,'ATK%','Bõnus Electro%','Taxa Crítica%','Crit Rate,  Crit DMG, ATK','ATK 2000; Crit Rate +60%.'),(14,6,8,'Grande capacidade de Maestria Elemental.',9,'Maestria Elemantal','Maestria Elemental','Maestria Elemental','Recarga de Energia, Maestria Elemental, Crit Rate','Recarga de Energia +170%'),(15,7,10,'Aumenta tanto a defesa quanto o Crti DMG.',5,'DEF%','Bônus Geo%','Taxa Crítica%','DEF%, Crit DMG, Crit Rate ','Recarga de Energia +180%');
...
-- Dump completed on 2025-11-23  0:11:55
